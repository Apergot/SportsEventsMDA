...
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description, enrolled) VALUES ('Torneo de Ciclismo', 'Las palmas de GC', 12000, '2020-05-10', 'Competición de ciclismo',0);
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description, enrolled) VALUES ('Torneo de Atletismo', 'Tafira Alta', 4500, '2020-05-20', 'Competición de atletismo',0);
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description, enrolled) VALUES ('Torneo de Baloncesto', 'Telde', 8000, '2020-05-20', 'Competición de baloncesto',0);
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description, enrolled) VALUES ('Torneo de Halterofilia', 'Arucas', 5000, '2020-05-20', 'Competición de halterofilia',0);
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description, enrolled) VALUES ('Torneo de Patinaje', 'Gáldar', 1200, '2020-05-20', 'Competición de patinaje',0);

INSERT INTO enrollments (rivalry_id, user_id, state) VALUES (1, 3, 'ENABLED');
