...
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description) VALUES ('Torneo de Ciclismo', 'Las palmas de GC', 12000, '2020-05-10', 'Competición de ciclismo');
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description) VALUES ('Torneo de Atletismo', 'Tafira Alta', 4500, '2020-05-20', 'Competición de atletismo');
INSERT INTO rivalries (rivalryname, location, capacity, rivalrydate, description) VALUES ('Torneo de Baloncesto', 'Telde', 8000, '2020-05-20', 'Competición de baloncesto');
